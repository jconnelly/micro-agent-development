#!/usr/bin/env python3
"""
Phase 15A Language Detection Test Script
...
public:
    bool validatePolicy(const std::string& applicantData) {
        if (getAge(applicantData) < MIN_AGE) {
            return false;
        }
        return true;
    }
...
int main() {
    ...
    return 0;
      ...
      """,
        ...
        {
            "filename": "legacy_proc.pli",
            "content": """
INSURANCE_VALIDATION: PROCEDURE;

   DCL APPLICANT_AGE FIXED BIN(15);
   DCL CREDIT_SCORE FIXED BIN(15);
   DCL STATUS CHAR(10) VAR;
...
END INSURANCE_VALIDATION;
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        try:
            ...
            if detection_result.profile and detection_result.is_confident:
                ...
                print(f"⚙️  Chunking: size={chunking['preferred_size']} "
    ...
    for result in results:
        ...
        conf_indicator = "🔥" if result["confident"] else "⚠️ "
    ...
    if success:
        ...
        print("   - Detection accuracy ≥ 80% ✅")
        print("   - High confidence rate ≥ 80% ✅") 
        print("   - Ready for production use with BusinessRuleExtractionAgent")
    else:
        print("⚠️  NEEDS IMPROVEMENT: Language detection system needs tuning")
